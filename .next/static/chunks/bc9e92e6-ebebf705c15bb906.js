"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,r){r.d(t,{ET:function(){return i8},IO:function(){return iQ},Xo:function(){return iY},ad:function(){return iE},cf:function(){return i5},hJ:function(){return iy}});var n,i,s=r(3991),a=r(5538),o=r(6914),l=r(8745),u=r(613);r(2601);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i1{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class i2 extends iB{constructor(e,t,r,n,i,s){super(e,t,r,n,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new i4(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let r=this._document.data.field(i$("DocumentSnapshot.get",e));if(null!==r)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class i4 extends i2{data(e={}){return super.data(e)}}class i3{constructor(e,t,r,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new i1(n.hasPendingWrites,n.fromCache),this.query=r}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new i4(this._firestore,this._userDataWriter,r.key,r,new i1(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new E(_.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(r=>{let n=new i4(e._firestore,e._userDataWriter,r.doc.key,r.doc,new i1(e._snapshot.mutatedKeys.has(r.doc.key),e._snapshot.fromCache),e.query.converter);return r.doc,{type:"added",doc:n,oldIndex:-1,newIndex:t++}})}{let r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let n=new i4(e._firestore,e._userDataWriter,t.doc.key,t.doc,new i1(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(s=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return v()}}(t.type),doc:n,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}class i9 extends i0{constructor(e){super(),this.firestore=e}convertBytes(e){return new iC(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ip(this.firestore,null,t)}}function i8(e,t){var r,n,i;let s=ih(e.firestore,i_),a=function(e,t,...r){if(e=(0,l.m9)(e),1==arguments.length&&(t=R.newId()),ia("doc","path",t),e instanceof id){let n=F.fromString(t,...r);return io(n),new ip(e,null,new q(n))}{if(!(e instanceof ip||e instanceof ig))throw new E(_.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(F.fromString(t,...r));return io(n),new ip(e.firestore,e instanceof ig?e.converter:null,new q(n))}}(e),o=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return(i=[(function(e,t,r,n,i,s={}){let a,o;let u=e.pu(s.merge||s.mergeFields?2:0,t,r,i);iF("Data must be an object, but it was:",u,n);let h=iM(n,u);if(s.merge)a=new en(u.fieldMask),o=u.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=function(e,t,r){if((t=(0,l.m9)(t))instanceof iS)return t._internalPath;if("string"==typeof t)return iU(e,t);throw iq("Field path arguments must be of type string or ",e,!1,void 0,r)}(t,n,r);if(!u.contains(i))throw new E(_.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new en(e),o=u.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=u.fieldTransforms;return new ik(new eD(h),a,o)})(iL(e.firestore),"addDoc",a._key,o,null!==e.converter,{}).toMutation(a._key,tS.exists(!1))],function(e,t){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>n$(await it(e).then(e=>e.syncEngine),t,r)),r.promise}(iT(s),i)).then(()=>a)}function i5(e,...t){var r,n,i;let s,a,o;e=(0,l.m9)(e);let u={includeMetadataChanges:!1},h=0;"object"!=typeof t[0]||iv(t[h])||(u=t[h],h++);let c={includeMetadataChanges:u.includeMetadataChanges};if(iv(t[h])){let e=t[h];t[h]=null===(r=e.next)||void 0===r?void 0:r.bind(e),t[h+1]=null===(n=e.error)||void 0===n?void 0:n.bind(e),t[h+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof ip)a=ih(e.firestore,i_),o=new e0(e._key.path),s={next:r=>{t[h]&&t[h](function(e,t,r){let n=r.docs.get(t._key),i=new i9(e);return new i2(e,i,t._key,n,new i1(r.hasPendingWrites,r.fromCache),t.converter)}(a,e,r))},error:t[h+1],complete:t[h+2]};else{let r=ih(e,im);a=ih(r.firestore,i_),o=r._query;let n=new i9(a);s={next:e=>{t[h]&&t[h](new i3(a,n,r,e))},error:t[h+1],complete:t[h+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
